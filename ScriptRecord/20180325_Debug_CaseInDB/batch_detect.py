...
with open("D:/UserData/Desktop/data_to_review.csv", mode="r", encoding="utf-8") as in_, open("D:/UserData/Desktop/data_fixed_v1_part1.csv", mode="w", encoding="utf-8") as out_:
    count = 0
    line = in_.readline()
    while line:
        print(count)
